...
const LIQUIDITY_INFO = {
  ...
  'COMPOSITE': 'Production liquidity composite signal. The 5F production model combines BIS global credit (quantity), G4 central bank balance sheets (M2), credit spreads (HY OAS), dollar/cross-currency stress, and rate regime (Fed Funds 6M change) into a single tightening/loosening reading. Each factor is z-scored on a 36-month rolling window with equal 20% weights; a 6-month momentum transform is then applied to the composite.',
  ...
  return (
    <div>
      <div style={{ padding: '8px 12px', marginBottom: 12, background: '#1a0000',
        border: '1px solid rgba(255,0,0,0.25)', fontSize: 11, color: '#ff4444' }}>
        ⚠ EXPERIMENTAL — NOT PRODUCTION. No active experiments.
      </div>
    </div>
  );
}
